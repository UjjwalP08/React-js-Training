    ...
    return (
        <form onSubmit={submitHandler}>
            <div className='new-expense__controls' >
                ...
                <div className='new-expense__controls'>
                    <label>Amount</label>
                    <input type='number' min='0.01' step='0.01' onChange={getAmount} value={enterAmount} />
                </div>
                <div className='new-expense__controls'>
                    <label></label>
                    <input type='date' min='2019-01-01' max='2023-12-31' onChange={getDate} value={enterDate} />
                </div>
